...
@Component({
  selector: 'app-live-location-sharing-android-messaging-app',
  templateUrl: './live-location-sharing-android-messaging-app.component.html',
  styleUrls: ['./live-location-sharing-android-messaging-app.component.less']
})
export class LiveLocationSharingAndroidMessagingAppComponent implements OnInit {
  images = {
