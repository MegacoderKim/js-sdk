...
var HtMapService = (function (_super) {
    tslib_1.__extends(HtMapService, _super);
...
var HtUsersService = (function (_super) {
    tslib_1.__extends(HtUsersService, _super);
...
var UsersContainerComponent = (function () {
    ...
    Object.defineProperty(UsersContainerComponent.prototype, "queryMap", {
        ...
        get: function () {
            ...
            return this.showAll ? tslib_1.__spread(this._queryMap, showAllLabel) : this._queryMap;
        },
        enumerable: true,
        configurable: true
    });
...
var PlacelineComponent = (function () {
    ...
    Object.defineProperty(PlacelineComponent.prototype, "placelineMod", {
        ...
        get: function () {
            ...
            var activitySegments = reduce(this.userData.segments, function (acc, segment) {
                ...
                var /** @type {?} */ activitySegments = tslib_1.__spread(acc.activitySegments, gapSegment, [currentActivitySegment]);
            ...
            var _b = reduce(tslib_1.__spread(activitySegments, [lastSeg]), function (acc, segment, i, placelineM) {
            ...
            var /** @type {?} */ unsortedCurrentSegment = tslib_1.__spread(activitySegments, actionSegments);
            ...
            if (restActiviySegments.length == 1 && restActiviySegments[0].actionText && lastSeg['time']) {
                ...
                if (actionTime == lastTime) {
                    return lastSeg['time'] ? tslib_1.__spread(currentSegment, restActiviySegments, expActionSegments) : tslib_1.__spread(currentSegment, expActionSegments);
                }
            }
            return lastSeg['time'] ? tslib_1.__spread(currentSegment, [lastSeg], restActiviySegments, expActionSegments) : tslib_1.__spread(currentSegment, expActionSegments);
        },
        enumerable: true,
        configurable: true
    });
    ...
    PlacelineComponent.prototype.currentExpActions = function (actions) {
        ...
        return reduce(actions, function (acc, action) {
            ...
            var /** @type {?} */ currentActions = (assign.actionTime) ? tslib_1.__spread(acc.currentActions, [assign]) : acc.currentActions;
            if (action.display.ended_at) {
                ...
                currentActions = tslib_1.__spread(currentActions, [end]);
            }
            else {
...
var HtGroupsService = (function (_super) {
    tslib_1.__extends(HtGroupsService, _super);
...
var GroupsChartService = (function () {
    ...
    GroupsChartService.prototype.setGroupsLevels = function () {
        ...
        this.groupsSub = this.selectedGroups$.pipe(filter(function (data) { return !!data.length; }), withLatestFrom(this.groupsLevelsEntity$), switchMap(function (_a) {
            var _b = tslib_1.__read(_a, 2), selectedGroups = _b[0], groupsLevels = _b[1];
...
var DateRangePickerComponent = (function () {
    function DateRangePickerComponent() {
        ...
        this.customDates = DateRangeLabelMap;
        var /** @type {?} */ monthStart = startOfMonth(new Date());
    ...
    DateRangePickerComponent.prototype.changeMonth = function (inc) {
        var /** @type {?} */ month = addMonths(new Date(this.currentMonthStart$.getValue()), inc);
    ...
    DateRangePickerComponent.prototype.generateDates = function (monthStart, dateStyle) {
        var _this = this;
        var /** @type {?} */ start = startOfWeek(monthStart);
        ...
        var /** @type {?} */ days = weekStarts.map(function (weekStart) {
            return [0, 1, 2, 3, 4, 5, 6].map(function (i) {
                var /** @type {?} */ date = addDays(weekStart, i);
...
var HtClientService = (function (_super) {
    tslib_1.__extends(HtClientService, _super);
...
var UsersAnalyticsListService = (function () {
    ...
    UsersAnalyticsListService.prototype.initState = function (config) {
        ...
        if (config.tags && config.tags.length)
            this.tags = tslib_1.__spread(this.tags, config.tags);
    };
    /**
     * @param {?} config
     * @return {?}
    ...
    UsersAnalyticsListService.prototype.initClient = function (config) {
        var _this = this;
        var /** @type {?} */ userClient = usersClientFactory({ dateRange: this.dateRangeService$ });
...
var UsersSummaryService = (function () {
    ...
    UsersSummaryService.prototype.setState = function (config) {
        ...
        this.title = config.title;
        var /** @type {?} */ client = config.client || usersClientFactory({ dateRange: this.dateRangeService$ });
        client.setShowAll();
...
var ActionsStatusGraphService = (function () {
    ...
    ActionsStatusGraphService.prototype.initClient = function () {
        var _this = this;
        var /** @type {?} */ graphClient = actionsClientFactory({ dateRange: this.dateRangeService$ });
...
var ActionsAnalyticsListService = (function () {
    ...
    ActionsAnalyticsListService.prototype.initClient = function (config) {
        var _this = this;
        var /** @type {?} */ userClient = actionsClientFactory({ dateRange: this.dateRangeService$ });
        this.client = userClient.list;
        this.client.updateStrategy = config.updateStrategy || "once";
        this.client.setQuery(this.query);
        this.loading$ = this.client.loading$;
...
var ActionsSummaryService = (function () {
    ...
    ActionsSummaryService.prototype.initState = function (config) {
        ...
        this.title = config.title;
        var /** @type {?} */ client = config.client || actionsClientFactory({ dateRange: this.dateRangeService$ });
...
var ActionsHeatmapService = (function () {
    ...
    ActionsHeatmapService.prototype.initClient = function (config) {
        ...
        this.dateRangeService$ = dateRangeFactory(config.initialDateRange || DateRangeMap.last_7_days);
        this.title = config.title;
        var /** @type {?} */ actionsClient = actionsClientFactory({ dateRange: this.dateRangeService$ });
...
var AnalyticsItemsService = (function () {
    function AnalyticsItemsService() {
        ...
        var /** @type {?} */ usersClient = usersClientFactory({ dateRange: dateRangeFactory(DateRangeMap.today) });
        ...
        var /** @type {?} */ actionsClient = actionsClientFactory({ dateRange: actionDateRangeService });
        this.presets = [
            ...
            usersAnalyticsListPresets["users_summary"](usersClient, 'Users activity summary', tslib_1.__spread(activityQueryLabel, showAllQueryLable)),
            ...
            this.allTags$ = this.items$.pipe(map$1(function (items) {
                ...
                return items.reduce(function (tags, item) {
                    ...
                    return itemTags.reduce(function (currentTags, tag) {
                        return currentTags.includes(tag) ? currentTags : tslib_1.__spread(currentTags, [tag]);
                    }, tags);
    ...
    AnalyticsItemsService.prototype.toggleTag = function (tag) {
        ...
        this.selectedTags$.pipe(take(1))
            ...
            //   tags = [];
            // }
            _this.selectedTags$.next(tslib_1.__spread(tags));
        });
    };
    ;
    /**
...
var AnalyticsSelectorComponent = (function () {
    ...
    AnalyticsSelectorComponent.prototype.ngOnInit = function () {
        (_a = this.choosenPreset).push.apply(_a, tslib_1.__spread(this.analyticsItemsService.presets));
        var _a;
        // setTimeout(() => {
        //   this.setPreset()
        // });
...
var HtAccountService = (function (_super) {
    tslib_1.__extends(HtAccountService, _super);
...
var HtActionsService = (function (_super) {
    tslib_1.__extends(HtActionsService, _super);
