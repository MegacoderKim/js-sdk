...
export class MarkerClusterer extends google.maps.OverlayView {
  ...
  private maxZoom_: any | null;
  imagePath_: string;
  imageExtension_;
  zoomOnClick_: boolean;
  averageCenter_: any;
  prevZoom_: number;
  constructor(map: google.maps.Map, opt_markers: google.maps.Marker[], opt_options: Partial<IMarkerClustererOptions>) {
    super();
    console.log("init");
    extend(this, google.maps.OverlayView)
    this.map_ = map;
    this.init(map, opt_markers, opt_options)
  }
  ...
  init(map, opt_markers, opt_options: Partial<IMarkerClustererOptions> = {}) {
    /**
...
export class ClusterIcon extends google.maps.OverlayView{
  styles_: IClusterStyles[];
  private padding_: any | number;
  private cluster_: Cluster;
  private map_: google.maps.Map;
  private center_: any;
  private div_: null | HTMLElement;
  private sums_;
  private visible_: boolean;
  private url_: any;
  constructor(cluster: Cluster, styles: IClusterStyles[], opt_padding) {
    super();
    extend(this, google.maps.OverlayView)
    this.styles_ = styles;
...
function extend (obj1, obj2) {
  return (function(object) {
    for (var property in object.prototype) {
      if(property !== 'constructor') this.__proto__[property] = object.prototype[property];
    }
    return this;
  }).apply(obj1, [obj2]);
};
