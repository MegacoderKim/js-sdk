...
export declare type HtMap = L.Map | google.maps.Map;
export declare type HtBounds = L.LatLngBounds | google.maps.LatLngBounds;
export declare type HtPolyline = L.Polyline | google.maps.Polyline;
export declare type HtLatLng = L.LatLng | google.maps.LatLng;
export declare type HtMarker = L.CircleMarker | L.Circle | L.Marker | L.DivIcon | google.maps.Marker | google.maps.Circle;
...
export interface IReplayHead {
    ...
    bearing: number;
    currentSegment: IDecodedSegment | ISegment;
