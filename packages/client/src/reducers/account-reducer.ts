...
export function reducer(state: State = initialState, action : AccountDispatcher.All): State {
  switch (action.type) {
...
export const getCurrentKey = createSelector(getKey, getTempKey, (key, tempKey) => {
  return tempKey || key;
})
