...
export class SetupGuideComponent implements OnInit {
  ...
  /**
   * Find the plan Object from the plan ID
   * @param planID
   */
  ...
  /**
   * Toggles the widgets of the keys in first step
   * @param type
   */
  ...
  /**
   * Opens Intercom chat on clicking enterprise plan
   */
  ...
  /**
   * Initiate copy timer to show copied message for a while
   * @param key
   */
